...
<ul>
  <li><a class="active" href="railwayform.php">Home</a></li>&nbsp;&nbsp;&nbsp;
  <li><a href="pnr.php">PNR Enquiry</a></li>&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="main_slider_area">
                            <div class="slider">
                                <div class="single_slider wow fadeIn" data-wow-duration="2s">
                                    ...
                                    <p>Indian Railways (reporting mark IR) is a state-owned national transportation system, and it is responsible for rail transport in India. It is owned and operated by the Government of India through the Ministry of Railways. It is the fourth largest railway network in the world comprising 119,630 kilometres (74,330 mi) of total track and 92,081 km (57,216 mi) of running track over a route of 66,687 km (41,437 mi) with 7,216 stations at the end of 2015-16.
                               </p> </div>
                ...
                <div class="row text-center">
                    <div class="col-sm-6 col-xs-6 no-padding">
                        <div class="single_register single_login">
                            <a href="loginform.php">User Login</a>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-6 no-padding">
